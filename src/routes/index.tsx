...
const phases: { label: string; state: "done" | "next" | "planned" }[] = [
  ...
  { label: "Phase 3 — Authentication", state: "next" },
  { label: "Phase 4 — User management", state: "planned" },
  { label: "Phase 5 — Wallet", state: "planned" },
  { label: "Phase 6 — Immutable ledger", state: "planned" },
  { label: "Phase 7 — Demo game engine", state: "planned" },
